 ...
 */
function initOptions(userPreference) {
    var scrollbar = this;
    ...
    var isContinous = function isContinous() {
        ...
        switch (mode) {
            case 'auto':
                return _utils.getPrivateProp.call(scrollbar, 'isNestedScrollbar');
            default:
                return !!mode;
        }
    };
    ...
    var optionAccessors = {
        ...
        set alwaysShowTracks(v) {
            ...
            var _ref = _utils.getPrivateProp.call(scrollbar, 'targets');

            var container = _ref.container;


            if (v) {
                _apis.showTrack.call(scrollbar);
                container.classList.add('sticky');
            } else {
                _apis.hideTrack.call(scrollbar);
    ...
    (0, _keys2.default)(options).filter(function (prop) {
        ...
        (0, _defineProperty2.default)(optionAccessors, prop, {
            ...
            set: function set(v) {
                ...
                options[prop] = _helpers.pickInRange.apply(undefined, [v].concat(_toConsumableArray(limit[prop])));
            }
        });
    });

    _utils.setPrivateProp.call(this, 'options', optionAccessors);
    _apis.setOptions.call(this, userPreference);
};