...
function handleKeyboardEvents() {
    ...
    _dom.addEvent.call(this, container, 'keydown', function (evt) {
        ...
        var movementLocked = _ref2.movementLocked;
        ...
        _render.unlockMovement.call(_this); // handle for multi keypress
        if (x && _overscroll.willOverscroll.call(_this, 'x', x)) movementLocked.x = true;
        if (y && _overscroll.willOverscroll.call(_this, 'y', y)) movementLocked.y = true;
    ...
    _dom.addEvent.call(this, container, 'keyup', function () {
