...
var Tracker = function () {
    function Tracker(touch) {
        ...
        this.lastPosition = (0, _getPointerPosition.getPointerPosition)(touch);
    }
    ...
    _createClass(Tracker, [{
        ...
        value: function update(touch) {
            ...
            var now = Date.now();
            var position = (0, _getPointerPosition.getPointerPosition)(touch);
...
var TouchRecord = exports.TouchRecord = function () {
    ...
    _createClass(TouchRecord, [{
        ...
        value: function getDelta() {
            var tracker = this.getActiveTracker();
        ...
        value: function getLastPosition() {
            ...
            var tracker = this.getActiveTracker() || this.lastTouch;

            var position = tracker ? tracker.lastPosition : this.primitiveValue;
