...
var _get_position = require('./get_position');

var _get_touch_id = require('./get_touch_id');
...
var TouchRecord = exports.TouchRecord = function () {
    ...
    (0, _createClass3.default)(TouchRecord, [{
        ...
        value: function isActiveTouch(eventOrID) {
            ...
            var id = typeof eventOrID === 'number' ? eventOrID : (0, _get_touch_id.getTouchID)(eventOrID);
        ...
        value: function start(evt) {
            this.init();
            this.update(evt);
            this.activeID = (0, _get_touch_id.getTouchID)(evt);
        ...
        value: function update(evt) {
            ...
            var now = Date.now();
            var position = (0, _get_position.getPosition)(evt);
