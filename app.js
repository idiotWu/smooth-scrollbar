	    ...
	    evts.split(/\s+/).forEach(function (name) {
	        [].concat(elems).forEach(function (el) {
	            el.addEventListener(name, function () {
	                handler.apply(_this, [].slice.call(_arguments));
	                shouldUpdate = true;
	            });
	        });
	    });
