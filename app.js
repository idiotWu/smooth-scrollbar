...
/***/ function(module, exports, __webpack_require__) {
	...
	addEvent(input, 'input', function (e) {
	    ...
	    timeRange = val * 1e3;
	    endOffset = Math.min(endOffset, Math.max(0, 1 - (end.time - start.time) / timeRange));
	});
